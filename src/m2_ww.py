...
if __name__ == "__main__":
    ...
    try:
        ...
        m2_spec = pd.read_csv(csv_file, delimiter=',',
                              usecols=params, encoding='utf-16') #general config
        drc_spec = pd.read_csv(drc_file, delimiter='\t') #drc rules
        # m2_spec
    except:
        print(m2_spec)
    ...
    for i in range(cell_number):
        ...
        ##TODO Ziyang get drc values from drc_spec
        ...
        for j in range(init_loc[1], total_y-wire_cd + init_loc[1], track_pitch):
            ...
            draw_wire_track(layout, outLayerNum, cell, l_m2, wire_cd,
